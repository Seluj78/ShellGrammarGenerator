...
$EXEC_PATH/resources/SGG_HeaderFileGen.sh $EXEC_PATH $INPUT_TMP $C_OUTPUT $INPUT
$EXEC_PATH/resources/SGG_Header_42.sh $C_OUTPUT
$EXEC_PATH/resources/SGG_tokenhandler.sh $INPUT_TMP
$EXEC_PATH/resources/SGG_includeGen.sh $C_OUTPUT $INPUT_TMP $EXEC_PATH $INPUT
$EXEC_PATH/resources/SGG_RemoveInfo.sh $INPUT_TMP
$EXEC_PATH/resources/SGG_ProcessNumbers.sh $INPUT_TMP $C_OUTPUT
$EXEC_PATH/resources/SGG_GoUpperCase.sh $INPUT_TMP
$EXEC_PATH/resources/SGG_Output3DArray.sh $INPUT_TMP $C_OUTPUT
